...
urlpatterns = [
    ...
    path('', views_class.General_page.as_view(), name='general'),
    path('standartnie_vicheti/', views_class.Standartnie_vicheti.as_view(), name='standartnie_vicheti'),
    path('nlj/', views_class.Nlg.as_view(), name='nlj'),
    path('minfin/', views_class.Minfin.as_view(), name='minfin'),
    path('minfin_eda/', views_class.Minfin_eda.as_view(), name='minfin_eda'),
    path('minfin_transport', views_class.Minfin_transport.as_view(), name='minfin_transport'),
    path('minfin_razvlechenia/', views_class.Minfin_razvlechenia.as_view(), name='minfin_razvlechenia'),
    path('minfin_ammortizatia/', views_class.Minfin_amortizatia.as_view(), name='minfin_ammortizatia'),
    path('minfin_prochee/', views_class.Minfin_prochee.as_view(), name='minfin_prochee'),
    path('minfin_nds/', views_class.Minfin_nds.as_view(), name='minfin_nds'),
